...
export default async function AdminPage() {
  ...
  if (!await isPlatformSuperAdmin(user)) return <div className="min-h-screen bg-surface-primary flex items-center justify-center p-8"><div className="card p-7 max-w-md text-center"><h1 className="text-xl font-bold">无平台运营权限</h1><p className="text-sm text-text-secondary mt-3">该入口仅向平台 super_admin 开放。企业内超级管理员不会自动获得平台运营权限。</p></div></div>;
